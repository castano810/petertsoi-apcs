...
public class TypistNode
{
    ...
    public TypistDLNode nextNode ()
    {
        return (TypistDLNode)next;
    }
    
    // Sets new reference for the list
    public void setNewNextRef (TypistNode nextObj) 
    {
        next = nextObj;
    }
    ...
    protected Typist object;          // Typist Object
    protected TypistNode next;        // Reference to next node
}
